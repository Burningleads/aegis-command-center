...
export default function BottomNavigation() {
  return (
    <nav className="fixed bottom-4 left-4 right-4 md:relative md:bottom-0 md:left-0 md:right-0 z-30">
      <div className="bg-black/50 border border-black/30 rounded-3xl backdrop-blur-md p-2 flex justify-between">
        {items.map((it) => (
          <NavLink
            key={it.to}
            to={it.to}
